  ...
  <div class="p-10 flex flex-col">
    ...
    <div class="mb-3 flex items-center justify-between bg-white py-1 px-1">
      ...
      <div class="mt-5 flex lg:mt-0 md:mt-0 sm:mt-0 lg:ml-4">
        <a href="{{ route('hostels.index') }}" type="button"
    ...
    <form action="{{ route('hostels.update', [$hostel]) }}" enctype="multipart/form-data" method="POST">
      @csrf
      @method('PUT')

      @include('agents.hostels.form', ['available' => true])
